# Generated by Django 2.2.7 on 2020-01-05 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.CharField(choices=[('B2B', 'B2B'), ('Retail', 'Retail')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warranty', models.CharField(max_length=20, null=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='logger.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('product_type', models.CharField(choices=[('Notebook', 'Notebook'), ('Smartphone', 'Smartphone'), ('Tablet', 'Tablet'), ('Other', 'Other')], max_length=20, null=True)),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='logger.Customer')),
                ('issue', models.ManyToManyField(to='logger.Repair')),
            ],
        ),
    ]
